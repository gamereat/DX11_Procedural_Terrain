...
DistanceBasedTesselation::~DistanceBasedTesselation()
{
...
void DistanceBasedTesselation::InitShader(WCHAR* vsFilename, WCHAR* psFilename)
{
...
void DistanceBasedTesselation::InitShader(WCHAR * vsFilename, WCHAR * hsFilename, WCHAR * dsFilename, WCHAR * psFilename)
{
...
void DistanceBasedTesselation::SetShaderParameters(ID3D11DeviceContext * deviceContext, const XMMATRIX & worldMatrix, const XMMATRIX & viewMatrix, const XMMATRIX & projectionMatrix, ID3D11ShaderResourceView * texture, TessellationBufferType tesselationInfo, Light * light[])
{
	HRESULT result;
...
void DistanceBasedTesselation::Render(ID3D11DeviceContext* deviceContext, int indexCount)
{
