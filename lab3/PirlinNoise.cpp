...
Grad PirlinNoise::grad3[12] =
{ Grad(1, 1, 0), Grad(-1, 1, 0), Grad(1, -1, 0), Grad(-1, -1, 0),
Grad(1, 0, 1), Grad(-1, 0, 1), Grad(1, 0, -1), Grad(-1, 0, -1),
Grad(0, 1, 1), Grad(0, -1, 1), Grad(0, 1, -1), Grad(0, -1, -1) };


Grad PirlinNoise::grad4[32] = { Grad(0,1,1,1), Grad(0,1,1,-1), Grad(0,1,-1,1), Grad(0,1,-1,-1),
...
int PirlinNoise::fastfloor(double x) {
	int xi = (int)x;
	return x<xi ? xi - 1 : xi;
}
